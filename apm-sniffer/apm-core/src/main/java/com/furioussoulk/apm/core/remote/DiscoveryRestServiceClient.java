...
import static com.furioussoulk.apm.core.conf.RemoteDownstreamConfig.Collector.GRPC_SERVERS;
...
public class DiscoveryRestServiceClient implements Runnable {
    private static final ILogger logger = LogManager.getLogger(DiscoveryRestServiceClient.class);
