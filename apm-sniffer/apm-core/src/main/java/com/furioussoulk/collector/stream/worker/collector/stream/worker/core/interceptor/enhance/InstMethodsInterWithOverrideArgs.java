...
import com.furioussoulk.collector.stream.worker.collector.stream.worker.core.plugin.loader.InterceptorInstanceLoader;
...
public class InstMethodsInterWithOverrideArgs {
    private static final ILogger logger = LogManager.getLogger(InstMethodsInterWithOverrideArgs.class);
