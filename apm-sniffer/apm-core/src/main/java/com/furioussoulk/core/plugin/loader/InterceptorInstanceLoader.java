...
package com.furioussoulk.core.plugin.loader;
...
public class InterceptorInstanceLoader {
    private static final ILogger logger = LogManager.getLogger(InterceptorInstanceLoader.class);
    ...
    public static <T> T load(String className, ClassLoader targetClassLoader)
            throws InvocationTargetException, IllegalAccessException, InstantiationException, ClassNotFoundException, PathNotFoundException {
